...
Suponga que se tiene una distribucion de probabilidad con función de densidad $f(x \sim \theta_1, \theta_2, \ldots, \theta_p)$ en la cual $\theta_1, \theta_2, \ldots, \theta_p$ corresponden a los parametros de la distribucion. Supongamos que se toma una muestra aleatoria $x_1, x_2, \ldots, x_n$.
